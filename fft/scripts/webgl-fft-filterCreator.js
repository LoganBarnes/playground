...
FFTLibGL.prototype.setDrawUniforms = function(smb, program, args) {
	...
	this.gl.uniform1i(this.gl.getUniformLocation(this.getProgram(program), "uMakeFilter"), makeFilter);
}
...
FFTLibGL.prototype.renderScene = function(program) {
	if (makeFilter) {
		this.useProgram(program);
		this.drawToScreen(0, 0, program, [false, false, true, false, "orig", "reduce2"]);
	} else {
