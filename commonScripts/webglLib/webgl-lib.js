...
LibGL.prototype.renderPrimitives = function(program, callback, args) {
	...
	var prim;
	for (var i = 0; i < len; ++i) {
		this.renderPrimitive(i, program, callback, args);
	}
}
 ...
 */
LibGL.prototype.renderPrimitive = function(index, program, callback, args) {
	var prim = this.primitives[index];
 ...
 */
LibGL.prototype.addLinkedInput = function(elementID, reactiveElementID) {
	
	var element = document.getElementById(elementID);

	var reactiveElement = document.getElementById(reactiveElementID);
	element.oninput = function() {
		reactiveElement.value = this.value;
	}
