...
FFTLibGL.prototype.setSolverUniforms = function(smb, program, args) {
	this.gl.uniform1i(this.getUniform(program, "uGradient"), args[0]);
 ...
 *
 */
FFTLibGL.prototype.doGradients = function() {
	...
	// find gradient
	this.bindFramebuffer("solverBuffer", "grad");
 ...
 *
 */
FFTLibGL.prototype.doHOG = function() {
...
FFTLibGL.prototype.setDrawUniforms = function(smb, program, args) {
	...
	this.gl.uniform1i(this.getUniform(program, "uIsGradient"), args[2]);
...
FFTLibGL.prototype.renderScene = function(program) {
	...
	// draw gradient image
	this.useProgram(program);
	this.drawToScreen(this.TEX_WIDTH, this.TEX_HEIGHT, program, [false, false, true, false, "grad", "reduce2"]);
...
FFTLibGL.prototype.initShaders = function() {
	...
	this.addProgram("default", variable.theme_url + "/res/shaders/default.vert", variable.theme_url + "/res/shaders/default.frag",
					...
					["aPosition"],
					// uniforms
					["uIsGradient", "uMaxTex", "uThreshold", "uFilter",
	...
	this.addProgram("solver", variable.theme_url + "/res/shaders/solver.vert", variable.theme_url + "/res/shaders/solver.frag",
					...
					["aPosition"],
					// uniforms
					["uTexture", "uTexDim", "uGradient", "uRows"]);
...
FFTLibGL.prototype.initTextures = function() {
	...
	// face textures
	this.addTexture("grad", null, this.TEX_WIDTH, this.TEX_HEIGHT, this.gl.FLOAT, null);
...
function main() {
	...
	var fftLibGL = new FFTLibGL(null);
