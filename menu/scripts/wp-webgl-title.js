...
MenuLibGL.prototype.setUpGravityIcons = function() {
	...
	color = [1, 0, 0, 1];
	scale = [0.3, 0.3, 0.3];
	prim = this.addPrimitive(ShapeType.SPHERE, mat4.create(), color, [64.0, 0.0, 0.0, 0.0], "");
...
MenuLibGL.prototype.setUpRenderIcons = function() {
	...
	color = [1, 0.84, 0, 1];
	scale = [0.7, 0.7, 0.7];
	prim = this.addPrimitive(ShapeType.SPHERE, mat4.create(), color, [64.0, 1.0, 0.0, 0.0], "normals");
...
// /*
//  * Updates the time then begins the update loop.
//  */
// MenuLibGL.prototype.resumeTick = function() {
...
MenuLibGL.prototype.resizeCanvas = function() {
	var w = this.canvas_div.offsetWidth;
	var h = w * 0.56;
	this.resize(w, h);
 ...
 * @Override
 */
MenuLibGL.prototype.onStartTick = function() {
...
MenuLibGL.prototype.initShaders = function() {
	...
	// default shaders
	this.addProgram("default", variable.theme_url + "/shaders/title/default.vert", variable.theme_url + "/shaders/title/default.frag",
					// attributes
...
MenuLibGL.prototype.setScene = function() {
	...
	this.addModelJSON("ltb", variable.theme_url + "/objects/ltb.json",
						trans, [0.8, 0.8, 0.8, 1.0], [64.0, 0.0, 0.0, 0.0], "");
}
